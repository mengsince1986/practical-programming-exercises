import time
import find_two_smallest_frf
import find_two_smallest_simg
import find_two_smallest_wttl
...
if __name__ == '__main__':
    ...
    find_remove_find_time = time_find_two_smallest(
        find_two_smallest_frf.find_two_smallest, sea_levels)

    sort_get_minimums_time = time_find_two_smallest(
        find_two_smallest_simg.find_two_smallest, sea_levels)

    walk_through_time = time_find_two_smallest(
        find_two_smallest_wttl.find_two_smallest, sea_levels)
