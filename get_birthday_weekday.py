""" return the weekday of given birthday"""

def days_difference(day1: int, day2: int) -> int:
    """ Return the number of days between day1 and day2, which are both in the
    range 1-365 (thus indicating the day of the year).
...
def get_birthday_weekday(current_weekday: int, current_day: int, birthday_day:
    ...
    day of the week is current_weekday and the day of the year is current_day.
